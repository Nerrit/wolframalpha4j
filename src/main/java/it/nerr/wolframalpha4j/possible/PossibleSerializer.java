...
public class PossibleSerializer extends ReferenceTypeSerializer<Possible<?>> {
    ...
    public PossibleSerializer(ReferenceType fullType, boolean staticTyping, TypeSerializer vts,
                              JsonSerializer<Object> ser) {
        super(fullType, staticTyping, vts, ser);
    }

    public PossibleSerializer(ReferenceTypeSerializer<?> base, BeanProperty property, TypeSerializer vts,
    ...
    @Override
    protected PossibleSerializer withResolved(BeanProperty prop, TypeSerializer vts, JsonSerializer<?> valueSer,
