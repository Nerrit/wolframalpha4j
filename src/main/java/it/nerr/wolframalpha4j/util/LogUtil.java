...
public class LogUtil {
    ...
    public static final String KEY_BUCKET_ID = "wolframalpha4j.bucket";
    public static final String KEY_REQUEST_ID = "wolframalpha4j.request";
    public static final String KEY_GATEWAY_ID = "wolframalpha4j.gateway";
    public static final String KEY_SHARD_ID = "wolframalpha4j.shard";
    public static final String KEY_GUILD_ID = "wolframalpha4j.guild";
